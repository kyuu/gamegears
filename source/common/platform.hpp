...
#if defined(_WIN32)
#  define GAMEGEARS_WINDOWS
#elif defined(__unix__) || defined(__linux__)
#  define GAMEGEARS_LINUX
#elif defined(__APPLE__) && defined(__MACH__)
#  define GAMEGEARS_MAC_OS_X
#else
#  error Platform not supported
#endif

#if defined(_WIN32)
#  if defined(BUILDING_GAMEGEARS)
#    define GAMEGEARSAPI __declspec(dllexport)
#  else
#    define GAMEGEARSAPI __declspec(dllimport)
#  endif
#else
#  define GAMEGEARSAPI
#endif
